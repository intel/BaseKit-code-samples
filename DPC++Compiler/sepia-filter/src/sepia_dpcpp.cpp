...
static void report_time(const std::string &msg, cl::sycl::event e) {
  cl::sycl::cl_ulong time_start =
      ...
      e.get_profiling_info<cl::sycl::info::event_profiling::command_start>();
...
class SepiaFunctor {
 public:
  ...
  SepiaFunctor(
      ...
      cl::sycl::accessor<float, 1, sycl_write, sycl_global_buffer>
...
int main(int argc, char **argv) {
  ...
  */
  ...
  try {
    ...
    cl::sycl::buffer<float, 1> image_buf_exp1(image_exp1,

                                              cl::sycl::range<1>(img_len));
    ...
    e1 = q.submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class sepia>(

          cl::sycl::range<1>(IMG_SIZE), [=](cl::sycl::id<1> i) {
    ...
    cl::sycl::buffer<float, 1> image_buf_exp2(image_exp2,
